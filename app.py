...
# =============================================
st.set_page_config(
    page_title="ISO to RSNI Converter",
    page_icon="📄",
    layout="wide",
...
<style>
    ...
    /* ===== SVG ICON (dropdown arrow dll) ===== */
    .stSelectbox svg, .stTextInput svg {
        fill: #ffffff !important;
        color: #ffffff !important;
    }
...
<div style='text-align:center; padding:30px 0 10px 0;'>
    <h1 style='color:#ffffff; font-size:2.2rem; font-weight:800; margin:0;'>
        📄 ISO to RSNI Converter
    </h1>
    <p style='color:#4CAF50; font-size:1rem; margin-top:6px;'>
        Generator RSNI dari Dokumen ISO
    </p>
</div>
""", unsafe_allow_html=True)

st.markdown("<hr style='border:1px solid #4CAF50; margin:10px 0 25px 0;'>", unsafe_allow_html=True)
...
# =============================================
# TOMBOL PROSES (CONTOH)
# =============================================
st.markdown('<div class="section-label">🚀 Proses</div>', unsafe_allow_html=True)
...
if process_btn:
    if uploaded_file is not None:
        ...
        st.info(f"📄 No. SNI: {doc_title}  |  🌐 Bahasa: {LANG_OPTIONS[src_lang]}")
    else:
        st.error("❌ Silakan upload file .docx terlebih dahulu!")
